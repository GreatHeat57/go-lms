            ...
            <div class="row main-content">
                <div class="col-md-9">
                    ...
                    <div class="course-details-item border-bottom-0 mb-0">
                        ...
                        <div class="course_image_wrap">
                            <img class="course_image" src="{{asset('storage/courses/do_or_dont_gettyimages-_1200x772_684025232.png')}}" alt="logo">
                        </div>
                                        ...
                                        <form action="{{ route('lessons.test', [$lesson->slug]) }}" method="post">
                                            ...
                                            @foreach ($lesson->questions as $question)
                                                <div class="question_wrap">
                                                    <h4 class="question_title mb-0"><div class="question_number float-left">{{ $loop->iteration < 10 ? '0' . $loop->iteration : $loop->iteration }}</div> <div class="question_title_content float-left">{!! $question->question !!}</div> <div class="question_title_action float-right"><i class="fas fa-caret-down"></i><i class="fas fa-caret-up"></i></div></h4>
                ...
                <div class="col-md-3">
                    <div class="course_header">
                        <img class="course_badge" src="{{asset('images/badge/Warstwa_x0020_1.png')}}" alt="logo">
                        <div class="course_title">Dos and Dont's</div>
                        <div class="course_progress_wrap">
                            <div class="course_progress course_chapters">
                                <span class="float-left course_progress_label">Chapters</span>
                                <span class="float-right course_progress_value">11</span>
                                <span class="course_middle_mark">:</span>
                            </div>
                            <div class="course_progress course_chapters">
                                <span class="float-left course_progress_label">Author</span>
                                <span class="float-right course_progress_value">go-models</span>
                                <span class="course_middle_mark">:</span>
                            </div>
                            <div class="course_progress course_chapters">
                                <span class="float-left course_progress_label">Time</span>
                                <span class="float-right course_progress_value">10 min</span>
                                <span class="course_middle_mark">:</span>
                            </div>
                        </div>
                        <div class="course_title">Check also:</div>
                        <div class="checkalso_wrap">
                            <div class="checkalso">
                                <div class="checkalso_header">
                                    <img class="checkalso_header_image float-left" src="{{asset('images/badge/Warstwa_x0020_1.png')}}" alt="logo">
                                    <div class="checkalso_title float-left">Contract</div>
                                </div>
                                <div class="checkalso_content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue, suscipit a, scelerisque sed, lacinia in, mi. Cras vel lorem. Etiam pellentesque aliquet tellusdapibus aliquet, elit magna vulputate arcu.</div>
                            </div>
                            <div class="checkalso">
                                <div class="checkalso_header">
                                    <img class="checkalso_header_image float-left" src="{{asset('images/badge/Warstwa_x0020_1.png')}}" alt="logo">
                                    <div class="checkalso_title float-left">Fitness</div>
                                </div>
                                <div class="checkalso_content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue, suscipit a, scelerisque sed, lacinia in, mi. Cras vel lorem. Etiam pellentesque aliquet tellusdapibus aliquet, elit magna vulputate arcu.</div>
                            </div>
                            <div class="checkalso">
                                <div class="checkalso_header">
                                    <img class="checkalso_header_image float-left" src="{{asset('images/badge/Warstwa_x0020_1.png')}}" alt="logo">
                                    <div class="checkalso_title float-left">Comp card</div>
                                </div>
                                <div class="checkalso_content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue, suscipit a, scelerisque sed, lacinia in, mi. Cras vel lorem. Etiam pellentesque aliquet tellusdapibus aliquet, elit magna vulputate arcu.</div>
                            </div>
                        </div>
...
@push('after-scripts')
    ...
    <script>
        ...
        $('.question_title_action').click(function(){
            if ($(this).hasClass('question_opened')) {
                $(this).removeClass('question_opened');
                $(this).parent().parent().find('.radio_wrap').fadeOut();
            }
            else {
                $(this).addClass('question_opened');
                $(this).parent().parent().find('.radio_wrap').fadeIn();
            }
        });
