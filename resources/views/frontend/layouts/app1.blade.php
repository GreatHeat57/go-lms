                        ...
                        <div class="navbar-default">
                            <div class="navbar-header float-left">
                                <a class="navbar-brand text-uppercase" href="{{url('/')}}">
                                    {{--<img class="logo" src="{{asset("storage/logos/".config('logo_w_image'))}}" alt="logo">--}}
                                    <img class="logo" src="{{asset("storage/logos/".config('logo_w_image'))}}" alt="logo">
                                </a>
                            </div><!-- /.navbar-header -->
                            ...
                            <div class="backtogomodal float-right">
                                <a href="{{ url('/') }}">
                                    <img class="prev_go" src="{{asset('images/icons/prev.png')}}" alt="logo">
                                    Back to go-models
                                </a>
                            </div>
                        </div>
